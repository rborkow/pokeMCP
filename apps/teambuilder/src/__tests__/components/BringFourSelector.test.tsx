...
describe("BringFourSelector", () => {
    ...
    describe("rendering conditions", () => {
        ...
        it("renders null for undefined team", () => {
            const { container } = render(
                <BringFourSelector team={undefined as unknown as TeamPokemon[]} />,
            );
            expect(container.firstChild).toBeNull();
        });
        ...
        it("renders null for non-array team", () => {
            const { container } = render(
                <BringFourSelector team={"not an array" as unknown as TeamPokemon[]} />,
            );
            expect(container.firstChild).toBeNull();
        });
    ...
    describe("selection behavior", () => {
        ...
        it("allows selecting up to VGC_BRING_COUNT Pokemon", () => {
            ...
            expect(
                screen.getByText(`${VGC_BRING_COUNT}/${VGC_BRING_COUNT} selected`),
            ).toBeInTheDocument();
        });
