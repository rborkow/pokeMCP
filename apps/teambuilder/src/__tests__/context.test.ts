...
describe("AI Context", () => {
  describe("formatTeamContext", () => {
    ...
    it("includes item and ability", () => {
      const team: TeamPokemon[] = [
        { pokemon: "Garchomp", item: "Life Orb", ability: "Rough Skin", moves: [] },
      ];
      const result = formatTeamContext(team);
    ...
    it("includes Tera type", () => {
      const team: TeamPokemon[] = [
        { pokemon: "Garchomp", teraType: "Steel", moves: [] },
      ];
      const result = formatTeamContext(team);
  ...
  describe("buildUserMessage", () => {
    ...
    it("includes VGC analysis for VGC mode", () => {
      const team: TeamPokemon[] = [
        { pokemon: "Garchomp", moves: ["Earthquake", "Dragon Claw", "Swords Dance", "Stone Edge"] },
        { pokemon: "Kingambit", moves: ["Iron Head", "Sucker Punch", "Swords Dance", "Kowtow Cleave"] },
      ];
      const result = buildUserMessage(
