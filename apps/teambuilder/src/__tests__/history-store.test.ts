...
describe("history-store", () => {
    ...
    describe("pushState", () => {
        it("should add a history entry", () => {
            const team: TeamPokemon[] = [{ pokemon: "Garchomp", moves: ["Earthquake"] }];
        ...
        it("should limit history to 50 entries", () => {
            for (let i = 0; i < 60; i++) {
                useHistoryStore
                    .getState()
                    .pushState([{ pokemon: `Pokemon${i}`, moves: [] }], `Entry ${i}`, "user");
            }
    ...
    describe("calculateDiff", () => {
        ...
        it("should detect modified Pokemon - ability changed", () => {
            const before: TeamPokemon[] = [
                { pokemon: "Garchomp", moves: [], ability: "Rough Skin" },
            ];
    ...
    describe("clearHistory", () => {
        it("should clear all entries", () => {
            useHistoryStore
                .getState()
                .pushState([{ pokemon: "Garchomp", moves: [] }], "Test action", "user");
