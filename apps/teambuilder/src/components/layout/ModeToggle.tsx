        ...
        <>
            ...
            >
                <AlertDialogContent>
                    <AlertDialogHeader>
                        <AlertDialogTitle>
                            Switch to {pendingMode ? MODE_INFO[pendingMode].label : ""}?
                        </AlertDialogTitle>
                        <AlertDialogDescription>
                            You have {team.length} Pokémon in your team. Switching modes will change
                            the available formats and may affect team legality.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
