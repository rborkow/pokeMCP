...
export function PokemonEditDialog({ pokemon, open, onOpenChange, onSave }: PokemonEditDialogProps) {
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
                ...
                <div className="space-y-4">
                    ...
                    {/* EVs */}
                    <EVSection evs={editedPokemon.evs} evTotal={evTotal} onEVChange={updateEV} />
