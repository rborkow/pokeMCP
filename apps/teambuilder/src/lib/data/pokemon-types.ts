...
const POKEMON_BASE_STATS: Record<string, BaseStats> = {
  ...
  "zoroarkhisui": { hp: 55, atk: 100, def: 60, spa: 125, spd: 60, spe: 110 },
  ...
  "arcaninehisui": { hp: 95, atk: 115, def: 80, spa: 95, spd: 80, spe: 90 },
  "porygon2": { hp: 85, atk: 80, def: 90, spa: 105, spd: 95, spe: 60 },
  "porygonz": { hp: 85, atk: 80, def: 70, spa: 135, spd: 75, spe: 90 },
  ...
  "prankster pokemon": { hp: 60, atk: 85, def: 42, spa: 85, spd: 42, spe: 91 },
  // Additional VGC support
  "lilligant-hisui": { hp: 70, atk: 105, def: 75, spa: 50, spd: 75, spe: 105 },
  "lilliganthisui": { hp: 70, atk: 105, def: 75, spa: 50, spd: 75, spe: 105 },
  "samurott-hisui": { hp: 90, atk: 108, def: 80, spa: 100, spd: 65, spe: 85 },
  "samurotthisui": { hp: 90, atk: 108, def: 80, spa: 100, spd: 65, spe: 85 },
  "typhlosion-hisui": { hp: 73, atk: 84, def: 78, spa: 119, spd: 85, spe: 95 },
  "typhlosionhisui": { hp: 73, atk: 84, def: 78, spa: 119, spd: 85, spe: 95 },
  "decidueye-hisui": { hp: 88, atk: 112, def: 80, spa: 95, spd: 95, spe: 60 },
  "decidueyehisui": { hp: 88, atk: 112, def: 80, spa: 95, spd: 95, spe: 60 },
  "braviary-hisui": { hp: 110, atk: 83, def: 70, spa: 112, spd: 70, spe: 65 },
  "braviaryhisui": { hp: 110, atk: 83, def: 70, spa: 112, spd: 70, spe: 65 },
  "goodra-hisui": { hp: 80, atk: 100, def: 100, spa: 110, spd: 150, spe: 60 },
  "goodrahisui": { hp: 80, atk: 100, def: 100, spa: 110, spd: 150, spe: 60 },
  ...
  "kyuremwhite": { hp: 125, atk: 120, def: 90, spa: 170, spd: 100, spe: 95 },
  "kyuremblack": { hp: 125, atk: 170, def: 100, spa: 120, spd: 90, spe: 95 },
