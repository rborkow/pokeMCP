/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.toml` (hash: a4b8b6ead4e26baaf85f46a77db52455)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "ANTHROPIC_API_KEY" | "NEXT_PUBLIC_CF_ANALYTICS_TOKEN">> {}
}
