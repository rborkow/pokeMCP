/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.toml --env-file=worker-types.env` (hash: 18cb5f6b16649f2aea81ed2d5e328df8)
// Runtime types generated with workerd@1.20260708.1 2026-07-12 nodejs_compat
interface __BaseEnv_Env {
	PREP_DB: D1Database;
	META_DB: D1Database;
	ANALYTICS: AnalyticsEngineDataset;
	PREP_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	...
	PREP_ANALYSIS: Service /* entrypoint PrepAnalysisService from pokemon-mcp-production */;
	AI_RATE_LIMITER_CHAT: RateLimit;
	AI_RATE_LIMITER_STRICT: RateLimit;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "ANTHROPIC_API_KEY" | "CLOUDFLARE_AI_GATEWAY_URL" | "CF_AIG_TOKEN" | "BETTER_AUTH_SECRET" | "DISCORD_CLIENT_ID" | "DISCORD_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "NEXT_PUBLIC_CF_ANALYTICS_TOKEN">> {}
}
