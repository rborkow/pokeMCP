 ...
 */
export function rerankResults(results: SearchResult[], options: QueryOptions): RankedResult[] {
 ...
 */
export function filterByScore(results: RankedResult[], minScore = 0.5): RankedResult[] {
